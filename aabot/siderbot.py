...
cl = LINETCR.LINE()
cl.login(token="EmAqEXsw47UuZVz3rRU7.GgadPUD/xIN9sy7qF3Zs5W.B+p+J/08RaZd4LqR3A6gC2Hvwk4LhatSIK7Kd1wXvUA")
cl.loginResult()
...
def autolike():
     for zx in range(0,100):
	    ...
	    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by Giananda\n\ninstagram.com/gianandaal")
            print "Like"
          except:
            pass
        else:
